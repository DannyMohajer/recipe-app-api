...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        orginal_link = "https://example.comrecipe.pdf"
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying to delete abother users recipe gives error."""
        new_user = create_user(email="user2@example.com", password="test123")
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Ghorme sabzi")
        tag1 = Tag.objects.create(user=self.user, name="Vegan")
        tag2 = Tag.objects.create(user=self.user, name="Carnivore")
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title="Fish aand chips")
